...
![Kart Tasarım Kataloğu ana ekranında başlık, tasarım sayısı, arama ve kartlar](docs/kart-tasarim/gorseller/01-katalog.png)
...
![Alpagu kelimesiyle filtrelenen ön ve arka yüz tasarımları](docs/kart-tasarim/gorseller/02-tasarim-arama.png)
...
![Eşleşmeyen bir arama sonrasında Sonuç bulunamadı mesajı](docs/kart-tasarim/gorseller/05-sonuc-bulunamadi.png)
...
![Alpagu ön yüzünün büyütülmüş önizlemesi ve işlem düğmeleri](docs/kart-tasarim/gorseller/03-onizleme.png)
...
![Önizleme penceresinde dosya adının kopyalandığını gösteren düğme](docs/kart-tasarim/gorseller/04-dosya-adi-kopyalama.png)
...
<img src="docs/kart-tasarim/gorseller/06-mobil-katalog.png" alt="Telefonda Alpagu tasarımlarının listelendiği Kart Tasarım Kataloğu" width="390">
...
Mevcut bir dosyayı değiştirmek veya kaldırmak da kaynak klasör üzerinden yapılır. Katalog için ayrı bir yönetici hesabı yoktur; dosya yönetimi GitHub depo yetkileriyle yapılır. Kaynak repo veya klasör taşınırsa proje sorumlusunun `assets/config.js` ayarlarını güncellemesi gerekir.
