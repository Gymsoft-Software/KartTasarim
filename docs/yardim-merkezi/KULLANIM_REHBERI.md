...
![Yardım Merkezi ana sayfasında arama alanı, kategoriler ve rehber listesi](gorseller/01-rehber-listesi.png)
...
![Bir rehberin okuma ekranı, içindekiler, bağlantı kopyalama ve yazdırma düğmeleri](gorseller/02-rehber-okuma.png)
...
![E-posta ve parola alanlarıyla yönetici giriş ekranı](gorseller/03-yonetici-girisi.png)
...
![Yazı sayıları, filtreler ve mevcut yazıların bulunduğu yönetim paneli](gorseller/04-yonetim-paneli.png)
...
![Kategori listesi ve yeni kategori için doldurulmuş ad ve açıklama alanları](gorseller/05-kategoriler.png)
...
![Yeni yazının başlık, kategori, bağlantı adı, açıklama ve etiket alanları](gorseller/06-baslik-kategori.png)
...
![Seçilen görselin dosya adı, açıklama alanı ve yükleme düğmesi](gorseller/07-gorsel-yukleme.png)
...
![İçerik editöründe seçili ekran görüntüsü ve yüzde 75 genişlik ayarı](gorseller/08-icerik-gorsel-boyutu.png)
...
![Kontrol ve yayın adımında öne çıkarma seçeneği, taslak kaydetme ve yayınlama düğmeleri](gorseller/09-kontrol-yayin.png)
...
Kurulum ve hesap yetkilendirme bilgileri için [teknik kurulum kılavuzuna](../../Destek/README.md) bakın.
